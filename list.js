...
if (typeof S3_REGION != 'undefined') {
  var BUCKET_URL = 'https://' + BUCKET_NAME + '.' + S3_REGION + '.amazonaws.com/'; // e.g. just 's3' for us-east-1 region
  var BUCKET_WEBSITE_URL = location.protocol + '//' + location.hostname + '/' + BUCKET_NAME;
}
